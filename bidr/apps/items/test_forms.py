...
class TestItemCreateForm(TestCase):
    ...
    def test_form_valid(self):
        data = {"name": "test_item", "description": "test_item_description", "minimum_price": Decimal("1.00")}
        form = ItemCreateForm(data=data)
        self.assertTrue(form.is_valid())

    def test_form_valid_int_price(self):
        data = {"name": "test_item", "description": "test_item_description", "minimum_price": 5}
        form = ItemCreateForm(data=data)
        self.assertTrue(form.is_valid())

    def test_form_invalid_missing_name(self):
        data = {"description": "test_item_description", "minimum_price": Decimal("1.00")}
        form = ItemCreateForm(data=data)
